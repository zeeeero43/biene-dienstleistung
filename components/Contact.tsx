        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-1 font-bold uppercase tracking-wider">Telefon</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-1 font-bold uppercase tracking-wider">E-Mail</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-1 font-bold uppercase tracking-wider">Anschrift</p>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#252525] border border-gray-700 text-white rounded-lg p-4 focus:outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow transition-all placeholder:text-gray-600"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Nachricht</label>
                <textarea
                  rows={4}
                  required
                  ...
                  className="w-full bg-[#252525] border border-gray-700 text-white rounded-lg p-4 focus:outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow transition-all placeholder:text-gray-600 resize-none"
                ></textarea>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="privacy-consent" className="text-sm sm:text-base text-gray-400 cursor-pointer">
                  Ich habe die{' '}
                  <Link to="/datenschutz" className="text-brand-yellow hover:underline" target="_blank">
